...
<div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="form">
        ...
        } ?>">1. Nếu trang web sử dụng giao thức HTTP, hãy dùng HTTP bên trong iframe.</p>
        <p class="<?php if (strpos(site_url(), 'https://') !== false) {
            echo 'bold text-success';
        } ?>">2. Nếu trang web sử dụng giao thức HTTPS, hãy dùng HTTPS bên trong iframe.</p>
        <p>Nếu không cài đặt SSL thì các liên kết cũng không cài SSL bao gồm cả landing page.</p>
        <hr />
        <h4 class="bold">Thay đổi cột (Bootstrap)</h4>
        <p>
                <span class="label label-default">
