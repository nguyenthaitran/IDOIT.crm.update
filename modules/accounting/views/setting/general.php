    ...
    <div class="col-md-6 row">
      <h5 class="title mbot5"><?php echo _l('als_accounting') ?></h5>
        <div class="row">
          ...
          <?php
              $month = [
                          1 => ['id' => 'January', 'name' => _l('Tháng 1')],
                          2 => ['id' => 'February', 'name' => _l('Tháng 2')],
                          3 => ['id' => 'March', 'name' => _l('Tháng 3')],
                          4 => ['id' => 'April', 'name' => _l('Tháng 4')],
                          5 => ['id' => 'May', 'name' => _l('Tháng 5')],
                          6 => ['id' => 'June', 'name' => _l('Tháng 6')],
                          7 => ['id' => 'July', 'name' => _l('Tháng 7')],
                          8 => ['id' => 'August', 'name' => _l('Tháng 8')],
                          9 => ['id' => 'September', 'name' => _l('Tháng 9')],
                          10 => ['id' => 'October', 'name' => _l('Tháng 10')],
                          11 => ['id' => 'November', 'name' => _l('Tháng 11')],
                          12 => ['id' => 'December', 'name' => _l('Tháng 12')],
                         ];
