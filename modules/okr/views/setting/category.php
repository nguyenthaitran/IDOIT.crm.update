<div class="t2-col-md-12">
	<p class="text-info"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <b>Nhóm OKRs</b> giúp phân loại OKRs. Có thể dùng để kết nối OKRs với Balanced scorecard (BSC).</p>
	<?php if(has_permission('okr','','create') || is_admin()){ ?>
	<a href="#" onclick="add_setting_category(); return false;" class="btn btn-info mbot15 pull-left">
    	<?php echo _l('add'); ?>
	</a>
	<?php } ?>
