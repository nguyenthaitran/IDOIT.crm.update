...
<div class="panel-body">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<select id="circulation" name="circulation" class="selectpicker" data-width="100%" data-none-selected-text="Không có mục nào được chọn" data-live-search="true" tabindex="-98">
				<option value=""></option>
	...
	<p class="text-info"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <b>Checkin</b> là một cuộc họp nhanh 15-20 phút giữa người quản lý và nhân viên để báo cáo tiến độ OKRs và đặt ra ưu tiên cho tuần sắp tới, theo một tần suất đều đặn (thường là hàng tuần). Mục đích Checkin là để đảm bảo rằng OKRs luôn tiến triển.</p>
