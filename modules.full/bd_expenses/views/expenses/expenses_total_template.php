...
<div class="row">
  ...
  <div class="col-md-12 simple-bootstrap-select mbot5">
   ...
   <select class="selectpicker" data-width="auto" name="expenses_total_currency" onchange="init_bd_expenses_total();">
  ...
  <select data-none-selected-text="<?php echo date('Y'); ?>" data-width="auto" class="selectpicker" multiple name="expenses_total_years" onchange="init_bd_expenses_total();">
...
<?php } ?>
<div class="col-md-4 col-xs-12 total-column">
