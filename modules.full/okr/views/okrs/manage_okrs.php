...
<div class="col-md-12">
   ...
   <a href="<?php echo admin_url('okr/okrs_chart_org'); ?>" data-toggle="tooltip" title="" class="btn btn-default tree-chart" data-original-title="<?php echo _l('switch_to_chart_okr'); ?>" >
	<?php echo _l('switch_to_chart_okr'); ?>
	</a>
	<br>
	<br>
	<div class="row">
	...
	<p class="text-info"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <b>OKR (Objectives Key Results)</b> hay "Mục tiêu" và "Kết quả then chốt" là phương thức quản trị giúp tổ chức đạt được những mục tiêu đề ra.</p>
