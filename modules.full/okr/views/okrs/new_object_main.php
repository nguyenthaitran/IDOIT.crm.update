...
<?php echo form_open_multipart(admin_url('okr/okrs_new_main'),array('id'=>'okrs-new-main-form'));?>
	<?php echo form_hidden('id', $okrs_id); ?> <span class="helpt2">(Ngắn gọn và cụ thể - Không được chứa số - Truyền cảm hứng - Chỉ nên có 3 đến 5 mục tiêu)</span>
	<div class="col-md-12">
	...
	<div class="col-md-6">
		...
		<select id="circulation" name="circulation" class="selectpicker circulation_new" data-width="100%" data-none-selected-text="Không có mục nào được chọn" data-live-search="true" tabindex="-98">
			<option value=""></option>
	...
	<div class="col-md-12">
		<h3><?php echo _l('key_results'); ?></h3> (Có chứa con số - Đo lường được - Chỉ nên có 1 đến 3 kết quả then chốt)
		<div class="list">
