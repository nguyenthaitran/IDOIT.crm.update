         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab_invoice">
               ...
               <div class="alert alert-info">
                  Hóa đơn định kỳ có trạng thái Đã hủy <b>vẫn là hóa đơn lặp lại liên tục</b>. Nếu bạn muốn dừng hóa đơn lặp lại này, bạn nên cập nhật trường định kỳ của hóa đơn thành <b>Không</b>.
               </div>
               <?php } ?>
