            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
					 ...
					 <?php if(is_admin()){ ?>				  
					  <a href="<?php echo admin_url('clients/groups'); ?>" class="btn btn-default"><?php echo _l('t2_client_group'); ?></a>
					  <?php } ?>
                  ...
                  <div class="checkbox">
                     ...
                     <label for="exclude_inactive">Ẩn Khách hàng không hoạt động</label>
                  </div>
