                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p class="font-medium">Nếu bạn có Module ở định dạng .zip, bạn có thể cài đặt Module đó bằng cách tải lên tại đây.</p>
                        </div>
                        <div class="col-md-4 col-md-offset-4">
                            <label for="module" class="control-label">Tải lên</label>
                            <div class="input-group">
                                <input type="file" class="form-control" name="module">
                                <span class="input-group-btn">
                                    <button class="btn btn-default p8" type="submit">Cài đặt</button>
                                </span>
                            </div><!-- /input-group -->
                        </div><!-- /.col-md-6 -->
                    </div>
