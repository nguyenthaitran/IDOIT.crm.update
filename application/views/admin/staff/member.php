      ...
      <div class="col-md-12">
         <?php if(total_rows(db_prefix().'departments',array('email'=>$member->email)) > 0) { ?>
            <div class="alert alert-danger">
               Email nhân viên cũng tồn tại dưới dạng email bộ phận hỗ trợ, theo tài liệu, email bộ phận hỗ trợ phải là email duy nhất trong hệ thống, bạn phải thay đổi email nhân viên hoặc email bộ phận hỗ trợ để mọi tính năng hoạt động bình thường.
            </div>
         <?php } ?>
         <div class="panel_s">
