         ...
         <div class="col-md-12">
            <div class="panel_s mbot10">
               <div class="panel-body _buttons">
                  ...
                  <a href="<?php echo admin_url('bd_expenses/expense'); ?>" class="btn btn-info"><?php echo _l('new_expense'); ?></a> <a href="<?php echo admin_url('bd_expenses'); ?>" class="btn btn-default"><?php echo _l('t2_expenses_approve'); ?></a>
                  <?php } ?>
