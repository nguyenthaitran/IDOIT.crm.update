         ...
         <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?>">
            <div class="top_stats_wrapper">
               <?php
                  ...
                  ?>
               <p class="text-uppercase mtop5"><i class="hidden-sm fa fa fa-credit-card"></i> <?php echo _l('invoices_awaiting_payment'); ?>
         ...
         <div class="quick-stats-leads col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?>">
            <div class="top_stats_wrapper">
               <?php
                  ...
                  ?>
               <p class="text-uppercase mtop5"><i class="hidden-sm fa fa-volume-control-phone"></i> <?php echo _l('leads_converted_to_client'); ?>
         ...
         <div class="quick-stats-projects col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?>">
            <div class="top_stats_wrapper">
               <?php
                  ...
                  ?>
               <p class="text-uppercase mtop5"><i class="hidden-sm fa fa-tasks"></i> <?php echo _l('projects') . ' ' . $project_status['name']; ?><span class="pull-right"><?php echo $total_projects_in_progress; ?> / <?php echo $total_projects; ?></span></p>
               <div class="clearfix"></div>
               <div class="progress no-margin progress-bar-mini">
         ...
         <div class="quick-stats-tasks col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?>">
            <div class="top_stats_wrapper">
               <?php
                  ...
                  ?>
               <p class="text-uppercase mtop5"><i class="hidden-sm fa fa-trello"></i> <?php echo _l('tasks_not_finished'); ?> <span class="pull-right">
