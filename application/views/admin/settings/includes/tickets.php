...
<div class="tab-content mtop30">
  ...
  <div role="tabpanel" class="tab-pane" id="ticket_form">
    <h4 class="bold">Thông tin form</h4>
     <p><b>Đường link tới form:</b>
    ...
    <hr />
    <h4 class="bold font-medium">Mã nhúng form</h4>
    ...
    <h4 class="mtop15 font-medium bold">Xem trực tiếp</h4>
    <p>
      <span class="label label-default">
    ...
    <hr />
    <p class="bold mtop15">Khi nhúng mã iframe xin lưu ý:</p>
    <p class="<?php if(strpos(site_url(),'http://') !== false){echo 'bold text-success';} ?>">1. Nếu trang web sử dụng giao thức HTTP, hãy dùng HTTP bên trong iframe.</p>
    <p class="<?php if(strpos(site_url(),'https://') !== false){echo 'bold text-success';} ?>">2. Nếu trang web sử dụng giao thức HTTPS, hãy dùng HTTPS bên trong iframe.</p>
    <p>Nếu không cài đặt SSL thì các liên kết cũng không cài SSL bao gồm cả landing page.</p>
    <hr />
    <h4 class="bold">Thay đổi độ rộng của form (sử dụng Bootstrap)</h4>
    <p>
      <span class="label label-default">
