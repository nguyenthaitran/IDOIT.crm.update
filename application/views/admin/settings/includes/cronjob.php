...
<p class="well">
  <span class="bold text-info">Lệnh Cron: wget -q -O- <?php echo site_url('cron/index'.(defined('APP_CRON_KEY') ? '/'.APP_CRON_KEY : '')); ?></span><br />
  <?php if(is_admin()){ ?>
  <a href="<?php echo admin_url('misc/run_cron_manually'); ?>">Chạy Cron thủ công</a><br />
  <?php } ?>
</p>
