...
<div class="row">
	<div class="col-md-12">		
		...
		<?php if($company_logo != ''){ ?>
			<div class="row">
				<div class="col-md-9">
					<img src="<?php echo base_url('uploads/company/'.$company_logo); ?>" class="img img-responsive mycrm">
				</div>
		...
		<?php if($company_logo_dark != ''){ ?>
			<div class="row hide">
				<div class="col-md-9">
					<img src="<?php echo base_url('uploads/company/'.$company_logo_dark); ?>" class="img img-responsive mycrm">
				</div>
				<?php if(has_permission('settings','','delete')){ ?>
					<div class="col-md-3 text-right">
		...
		<?php if($favicon != ''){ ?>
			<div class="form-group favicon hide">
				<div class="row">
					<div class="col-md-9">
		...
		<?php } else { ?>
			<div class="form-group favicon_upload hide">
