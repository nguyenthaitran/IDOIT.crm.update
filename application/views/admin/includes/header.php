...
<div id="header">
	...
	<div id="logo">
      <a href="/admin" class="logo img-responsive">
        <img src="https://cdn.t2.com.vn//assets/images/myCRM-LogoLight.svg" class="img-responsive" alt="T2 Co.,Ltd">
      </a>
	</div>
   <nav>
   ...
   <?php if(is_staff_member()){ ?>
      <li class="icon header-newsfeed">
         <a href="#" class="open_newsfeed desktop" data-toggle="tooltip" title="<?php echo _l('whats_on_your_mind'); ?>" data-placement="bottom"><i class="fa fa-commenting-o fa-fw fa-lg" aria-hidden="true"></i></a>
      </li>
   <?php } ?>
   <li class="icon header-todo">
      <a href="<?php echo admin_url('todo'); ?>" data-toggle="tooltip" title="<?php echo _l('nav_todo_items'); ?>" data-placement="bottom"><i class="fa fa-ioxhost fa-fw fa-lg"></i>
