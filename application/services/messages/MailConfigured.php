...
class MailConfigured extends AbstractPopupMessage
{
    ...
    {
        return 'Chúc mừng! Bạn đã cấu hình tính năng email thành công! <br /> <span style="font-size:26px;">Bạn có thể tắt bất kỳ email thông báo nào mà bạn không muốn gửi trong Hệ thống -> Mẫu email.</span>';
    }
}
