    ...
    public function getMessage()
    {
        ...
        if (get_option('default_timezone') == '') {
            ...
            if (!in_array(get_option('default_timezone'), $this->timezonesList)) {
                $html .= '<strong>Chúng tôi đã cập nhật logic múi giờ cho ứng dụng. Có vẻ như múi giờ trước của bạn không phù hợp với logic mới. Vào Hệ thống -> Cài đặt-> Ngôn ngữ và thời gian để cập nhật lại  cho phù hợp.</strong>';
            }
        }
