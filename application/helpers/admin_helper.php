...
function render_admin_js_variables()
{
    ...
    echo 'app.months_json = ' . $monthNames = json_encode([_l('Tháng 1'), _l('Tháng 2'), _l('Tháng 3'), _l('Tháng 4'), _l('Tháng 5'), _l('Tháng 6'), _l('Tháng 7'), _l('Tháng 8'), _l('Tháng 9'), _l('Tháng 10'), _l('Tháng 11'), _l('Tháng 12')]) . ';';
