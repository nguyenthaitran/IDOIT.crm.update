...
// CÔNG VIỆC		
        'projects' => [
            'name' => _l('projects'),
            'capabilities' => array_merge($withNotApplicableViewOwn, [ 'create_milestones' => 'Thêm mốc tiến độ', 
                'edit_milestones'=> 'Sửa mốc tiến độ','delete_milestones'=> 'Xóa mốc tiến độ']),
            'help'         => [
