...
class Client_merge_fields extends App_merge_fields
{
    public function build()
    {
        return [
                ...
                [
                    'name'      => 'Điện thoại người liên hệ chính',
                ...
                [
                    'name'      => 'Chức vụ người liên hệ chính',
                    'key'       => '{contact_title}',
                    'available' => [
                        'client',
                        'ticket',
                ...
                [
                    'name'      => 'Email người liên hệ chính',
                    'key'       => '{contact_email}',
                    'available' => [
                        'client',
                        'invoice',
                   ...
                   [
                    'name'      => 'Liên kết đặt mật khẩu mới',
                ...
                [
                    'name'      => 'Liên kết đặt lại mật khẩu',
