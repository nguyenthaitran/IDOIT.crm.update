...
class Import_customers extends App_import
{
    ...
    public function __construct()
    {
        ...
        $this->addImportGuidelinesInfo('Các dòng có email trùng lặp sẽ không được nhập vào hệ thống.', true);

        $this->addImportGuidelinesInfo('Hãy đảm bảo bạn đã thiết lập quyền và thông báo mặc định cho Người liên hệ tại <a href="' . admin_url('settings?group=clients') . '" target="_blank">Thiết lập -> Cài đặt -> Khách hàng</a>.');
    ...
    {			
		if (strtolower($field) == 'firstname') {
            return 'Tên';
        }
		if (strtolower($field) == 'lastname') {
            return 'Họ';
        }
		if (strtolower($field) == 'contact_phonenumber') {
            return 'Điện thoại';
        }
		...
		if (strtolower($field) == 'is_preffered') {
            return 'Ưu tiên';
        }					
		...
		if (strtolower($field) == 'billing_street') {
            return 'Địa chỉ thanh toán';
        }				
		if (strtolower($field) == 'billing_city') {
            return 'Quận/Huyện';
        }				
		if (strtolower($field) == 'billing_state') {
            return 'Tỉnh/Thành phố';
        }				
		if (strtolower($field) == 'billing_zip') {
            return 'Mã bưu chính';
        }				
		if (strtolower($field) == 'billing_country') {
            return 'Quốc gia';
        }				
		if (strtolower($field) == 'shipping_street') {
            return 'Địa chỉ nhận hàng';
        }				
		if (strtolower($field) == 'shipping_city') {
            return 'Quận/Huyện';
        }				
		if (strtolower($field) == 'shipping_state') {
            return 'Tỉnh/Thành phố';
        }				
		if (strtolower($field) == 'shipping_zip') {
            return 'Mã bưu chính';
        }				
		if (strtolower($field) == 'shipping_country') {
            return 'Quốc gia';
        }				
		...
		if (strtolower($field) == 'is_supplier') {
            return 'Nhà cung cấp';
        }				
		if (strtolower($field) == 'stripe_id') {
            return 'ID Stripe';
        }				
		if (strtolower($field) == 'loy_point') {
