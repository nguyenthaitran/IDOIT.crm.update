    ...
    private function set_default_triggers()
    {
        ...
        $triggers = [
            ...
            SMS_TRIGGER_INVOICE_OVERDUE => [
                ...
                'label'        => 'Nhắc hóa đơn quá hạn',
                'info'         => 'Kích hoạt khi thông báo hóa đơn quá hạn được gửi đến khách hàng.',
            ],

            SMS_TRIGGER_INVOICE_DUE => [
                'merge_fields' => array_merge($customer_merge_fields, $invoice_merge_fields),
                'label'        => 'Nhắc hóa đơn đến hạn',
                'info'         => 'Kích hoạt khi thông báo hóa đơn quá hạn được gửi đến khách hàng.',
            ],
            ...
            SMS_TRIGGER_PAYMENT_RECORDED => [
                ...
                'info'         => 'Kích hoạt khi hóa đơn được thanh toán.',
            ],
            ...
            SMS_TRIGGER_ESTIMATE_EXP_REMINDER => [
                ...
                'label' => 'Nhắc nhở hết hạn báo giá',
                'info'  => 'Kích hoạt khi thông báo nhắc hết hạn được gửi cho khách hàng.',
            ],

            SMS_TRIGGER_PROPOSAL_EXP_REMINDER => [
                'merge_fields' => $proposal_merge_fields,
                'label'        => 'Nhắc nhở hết hạn đề xuất',
                'info'         => 'Kích hoạt khi thông báo nhắc hết hạn được gửi cho đề xuất.',
            ],

            SMS_TRIGGER_PROPOSAL_NEW_COMMENT_TO_CUSTOMER => [
                'merge_fields' => $proposal_merge_fields,
                'label'        => 'Có bình luận mới trên đề xuất (gửi đến khách hàng)',
                'info'         => 'Kích hoạt khi Nhân viên bình luận vào Đề xuất, tin nhắn SMS sẽ gửi vào số liên hệ trên đề xuất (khách hàng/cơ hội).',
            ],

            SMS_TRIGGER_PROPOSAL_NEW_COMMENT_TO_STAFF => [
                'merge_fields' => $proposal_merge_fields,
                'label'        => 'Có bình luận mới trên đề xuất (gửi đến nhân viên)',
                'info'         => 'Kích hoạt khi khách hàng bình luận vào Đề xuất, tin nhắn SMS gửi đến người tạo đề xuất và nhân viên phụ trách.',
            ],

            SMS_TRIGGER_CONTRACT_NEW_COMMENT_TO_CUSTOMER => [
                'merge_fields' => array_merge($customer_merge_fields, $contract_merge_fields),
                'label'        => 'Có bình luận mới trên Hợp đồng (gửi đến khách hàng)',
                'info'         => 'Kích hoạt khi nhân viên thêm Bình luận vào hợp đồng, tin nhắn SMS sẽ gửi đến khách hàng.',
            ],

            SMS_TRIGGER_CONTRACT_NEW_COMMENT_TO_STAFF => [
                'merge_fields' => $contract_merge_fields,
                'label'        => 'Có bình luận mới trên Hợp đồng (gửi đến nhân viên)',
                'info'         => 'Kích hoạt khi khách hàng thêm bình luận vào hợp đồng, tin nhắn SMS được gửi đến người tạo hợp đồng.',
            ],

            SMS_TRIGGER_CONTRACT_EXP_REMINDER => [
                'merge_fields' => array_merge($customer_merge_fields, $contract_merge_fields),
                'label'        => 'Nhắc nhở hết hạn hợp đồng',
                'info'         => 'Kích hoạt khi thông báo hết hạn gửi đến khách hàng (qua tác vụ tự động Cron Job).',
            ],
            ...
            SMS_TRIGGER_STAFF_REMINDER => [
                ...
                'label' => 'Nhắc nhở nhân viên',
                'info'  => 'Kích hoạt khi nhân viên được nhắc nhở liên quan đến  <a href="' . admin_url('misc/reminders') . '">Nhắc nhở</a>.',
            ],
        ];
